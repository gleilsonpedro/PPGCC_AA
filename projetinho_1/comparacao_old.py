...
# n_values = sorted(random.sample(range(10, 3001), k)) #se quiser que termine no mesmo dia não coloque 10.000
n_values = sorted(set(map(int, np.logspace(1, 3.5, k))))  # Log scale evita muitos valores grandes, neste caso a 
